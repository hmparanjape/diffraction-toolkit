function [fighandle, elements, element_phase] = generate_habit_twin_mesh_3d(austenite_color_ip, CV1_color_ip, CV2_color_ip, ...
                                                      ...
                                                      foil_plane, bbox_half_width, number_of_twins_ip)
...
twin_offset = 0;
number_of_twins = number_of_twins_ip;
...
element_phase(mod(element_phase, 2) == 1) = 3;
element_phase(mod(element_phase, 2) == 0) = 1;
